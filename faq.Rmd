...
Here are some places where we'll try to put up directional markers:
- Start and end at the stone flower
- Take far road around deluxe tents
- Trail to exit PoL perimeter road
- Avoid shortcut through woods to farm
- Left out of woods around solar farm (not in between fields and solar)
- Exit farm through lower bridge
